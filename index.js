...
function renderSimpleTask() {
  // TODO: создать функцию рендеринга и провести рефакторинг
}
...
function createTask() {
  ...
  const taskComponent = /*html*/ `
  <div class="main__list-item main__list-sort" data-id="${id}">
  <input type="checkbox" class="done-btn" onclick="doneTask(this)" />
